...
const testimonials = [
  {
    quote: "Обработали наш офис за 3 часа. Быстро, качественно, без запаха. Все документы предоставили. Рекомендуем!",
    author: "Елена Соколова",
    role: "Управляющая торговым центром",
    image: "https://github.com/shadcn.png",
  },
  {
    quote: "После ремонта в квартире был страшный запах плесени. Специалисты приехали в тот же день, обработали все поверхности. Проблема решена!",
        ...
        <div className="flex flex-col gap-12">
          <div className="flex flex-col gap-4 md:gap-5 max-w-xl text-center md:text-left">
            ...
            <h2 id="testimonial-title" className="text-3xl md:text-4xl font-bold">
              Нам доверяют жители Екатеринбурга
            </h2>
          </div>
